...
export function ClaudePermission({
  ...
  return (
    <fieldset
      className={cn(
        "rounded-none border px-3.5 py-2.5 font-mono text-[13px] leading-[1.6] bg-[#08080a]",
        className,
      )}
      style={{ borderColor: ROSE }}
    >
      <legend className="px-2 font-bold" style={{ color: ROSE }}>
        {title}
      </legend>
      <div className="text-[#c0caf5] font-mono">{command}</div>
      <div className="mb-1.5 mt-2 text-[#c0caf5] font-semibold">{question}</div>
